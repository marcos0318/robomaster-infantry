...
void Brush_motor_pwm_dir_init(void){
  ...
  timer_init(TIM2, 27, TIM_CounterMode_Up, 65535, TIM_CKD_DIV1);//84000000/13/65536=49.3hz to be check
  
  pwm_timer_init(TIM_Channel_1,TIM2, TIM_OCMode_PWM1, TIM_OutputState_Enable, 65535*0.07, TIM_OCPolarity_High);//0 is pulse to be tune
	pwm_timer_init(TIM_Channel_3,TIM2, TIM_OCMode_PWM1, TIM_OutputState_Enable, 65535*0.05, TIM_OCPolarity_High);//0 is pulse to be tune
...
void Friction_wheel_init(){
	...
	timer_init(TIM1, 27, TIM_CounterMode_Up, 65535, TIM_CKD_DIV1);// 1khz
  
	pwm_timer_init(TIM_Channel_1,TIM1, TIM_OCMode_PWM1, TIM_OutputState_Enable, 7450, TIM_OCPolarity_High);//0 is pulse to be tune
